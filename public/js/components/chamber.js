AFRAME.registerComponent('chamber', {
	...
	init: function () {		
	    ...
	    evil.createEntity(el,{'id':'chamber-floor','geometry':'primitive:plane;width:12;height:4','position':'0 -0.19 -2','rotation':'-90 0 0','material':'color:#AAA;roughness:0.5;metalness:0.3'});
