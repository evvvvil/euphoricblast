...
var SUPPORTED_TYPES = ['video/*', 'image/*', 'application/pdf', 'application/postscript']; /*
...
var SUPPORTED_REGEX = new RegExp(/^video\/|image\/|application\/pdf|application\/postscript/g);
...
module.exports = _Field2.default.create({
	...
	getFilename: function getFilename() {
		var _props$value = this.props.value,
		    ...
		    context = _props$value.context;


		var label = public_id + '.' + format + ' (' + width + '\xD7' + height + ')';
		if (context && context.custom.filename) {
			label = context.custom.filename + ' (' + width + '\xD7' + height + ')';
		}
	...
	getSelectIcon: function getSelectIcon(resource_type) {
	...
	renderImagePreview: function renderImagePreview() {
		...
		var isVideo = value && value.resource_type === 'video' || /^data:video/.test(this.getImageSource());
		...
		function renderIcons() {
			...
			if (isVideo) {
				return _react2.default.createElement('i', { style: glyphStyles, className: 'octicon octicon-device-camera-video' });
			}
		}
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement('img', { src: this.getImageSource(), style: { height: 90, minWidth: 90 } }),
			renderIcons()
		);
	},
	renderOption: function renderOption(option, isValue) {
		var className = 'octicon octicon-' + this.getSelectIcon(option.resource_type);
		var styles = {
			image: {
		...
		return _react2.default.createElement(
			'div',
			null,
			_react2.default.createElement('img', { alt: label, src: option.thumbnail, style: styles.image }),
			_react2.default.createElement(
				'span',
				null,
				_react2.default.createElement('i', { style: styles.glyph, className: className }),
				label
			)
		);
	},
	handleSelectOnChange: function handleSelectOnChange(option) {
		this.setState({ selectValue: option ? option.value : null });
	},
	handleLoadOptions: function handleLoadOptions(input, callback) {
		var _props = this.props,
		    listPath = _props.listPath,
		    path = _props.path;


		var prefix = Keystone.options.cloudinaryPrefix ? Keystone.options.cloudinaryPrefix + '/' : '';
	...
	renderImageSelect: function renderImageSelect() {
		...
		return _react2.default.createElement(_reactSelect2.default.Async, {
			...
			optionRenderer: function optionRenderer(o) {
				return _this2.renderOption(o);
			},
			valueRenderer: function valueRenderer(o) {
				return _this2.renderOption(o, true);
			},
	...
	renderActionInput: function renderActionInput() {
		...
		if (this.state.userSelectedFile || this.state.removeExisting) {
			var value = this.state.userSelectedFile ? 'upload:' + this.state.uploadFieldPath : 'delete';
			return _react2.default.createElement('input', {
				name: this.getInputName(this.props.path),
				type: 'hidden',
				value: value
...
},{"../../../admin/client/App/elemental":65,"../../../admin/client/utils/cloudinaryResize":82,"../../components/FileChangeMessage":91,"../../components/HiddenFileInput":92,"../../components/ImageThumbnail":93,"../Field":99,"react":undefined,"react-images":undefined,"react-select":undefined}],105:[function(require,module,exports){
'use strict';
...
module.exports = _Field2.default.create({
	...
	getThumbnail: function getThumbnail(props, index) {
		...
		if (props.value && props.value.resource_type === 'video') {
			props.imageSourceSmall = props.imageSourceSmall.replace('image/upload', 'video/upload');
			props.imageSourceLarge = props.imageSourceLarge.replace('image/upload', 'video/upload');
		}
	...
	handleOpenImage: function handleOpenImage() {
	...
	renderFullButton: function renderFullButton() {
		if (this.state.lightboxIsVisible) {
			var url = this.state.thumbnails[this.state.lightboxImageIndex].props.value.secure_url;
			return _react2.default.createElement(
				_elemental.Button,
				{ size: 'xs', href: url, target: '_blank' },
				'Open Original'
			);
		}
	},
...
function CloudinaryImagesThumbnail(_ref) {
	...
	var isVideo = value && value.resource_type === 'video' || /^data:video/.test(imageSourceSmall);

	function renderInput() {
		if (!isQueued && value) {
			if (isDeleted) value.remove = true;
			return _react2.default.createElement('input', { type: 'hidden', name: inputName, value: JSON.stringify(value) });
		} else {
			return null;
		}
	}
	...
	function renderPreview() {
		if (isVideo && isQueued) {
			return _react2.default.createElement(
				'video',
				{ src: imageSourceSmall, height: 90 },
				'NO PREVIEW'
			);
		} else {
			// Force JPG thumbnail for videos, else would return the actual video
			return _react2.default.createElement('img', { src: imageSourceSmall + (isVideo ? '.jpg' : ''), style: { height: 90 } });
		}
	}
